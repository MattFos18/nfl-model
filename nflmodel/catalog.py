...
PROCESSED_WHAT = {
    ...
    "defender_games.parquet": ("one row per defender-game since 2013, every defensive snap matched by PFR id: snaps, credited plays, run stops, forced fumbles, coverage yards saved, interceptions, sacks, pressures, targets, and the defender value (EPA saved)", "positions", "Players tab; Rankings -> Positions"),
    "ol_games.parquet": ("one row per lineman-game: offensive snaps and his line unit's EPA saved in them (pressures allowed, yards before contact against the league)", "positions", "Players tab; Rankings -> Positions"),

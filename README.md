...
| Margin miss | 9.98 | 9.74 |
| Total miss | 10.26 | 10.12 |
| Brier (win odds) | 0.218 | 0.210 |
| Spreads at 3+ pt edge | 101-85 | |
| Spreads at 4+ pt edge (the flag) | 47-32 (2019 to 2025: 141-101; 133-91 outside Week 18) | |
...
disagreements with the close lose; 4+ point spread edges are 133-91 (59.4%) across 2019 to 2025 on the current model, above break-even in six of
seven seasons (a lead, not proof), and the live tracker is what settles it. The model has twenty inputs, each with one plain meaning

# Health check, 2026-09-23 12:50 UTC

**HEALTHY**: 0 failing, 1 warnings, 21 ok.

| Level | Check | Detail |
|---|---|---|
| OK | weekly run is fresh | last run 2026-09-23 05:07 UTC, 8 hours ago (limit 72) |
...
| OK | runs in the last seven days | 10 (four scheduled: Tue, Thu, Sat, Sun) |
| OK | verification suite passed | Result: PASS |
| OK | tie-out passed | Result: PASS (44 of 44 tie) |
| WARN | line watch is logging | last snapshot 5.7 hours ago, 13 in the last seven days (every 30 minutes when GitHub's cron fires) |
| OK | line watch returns rows | 1 of 13 snapshots in the last two days logged no lines |
| OK | kickoff forecasts are fresh | fetched 12 hours ago (limit 96) |

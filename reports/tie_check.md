# Tie-out (sources and page), 2026-09-25 06:56 UTC
...
| docs section 9 rule table: boosted trees alone, 5+ edge | 95-66 | 83-59 | 34-17 | 95-66 | 83-59 | 34-17 | yes |
| track record backtest columns: boosted trees alone, 5+ edge | 95-66 | 83-59 | 34-17 | 95-66 | 83-59 | 34-17 | yes |
| docs section 9 rule table: Under, 55%+ chance (the totals flag) | 159-130 | 202-150 | 68-61 | 159-130 | 202-150 | 68-61 | yes |
| track record backtest columns: Under, 55%+ chance (the totals flag) | 159-130 | 202-150 | 68-61 | 159-130 | 202-150 | 68-61 | yes |
...
| picks file stakes = tracker stakes | [0.87] | [0.87] | yes |
...
| This week's pull times = the newest rows in the line and prop logs | {'espn': '2026-09-25T06:45Z', 'oddsapi': '2026-09-24T12:08Z', 'props': '2026-09- | {'espn': '2026-09-25T06:45Z', 'oddsapi': '2026-09-24T12:08Z', 'props': '2026-09- | yes |
...
| cards' newest line snapshot = the line log's newest snapshot | 2026-09-25T06-45-01Z | 2026-09-25T06-45-01Z | yes |
| cards' Vegas win chance uses the line log's newest moneyline snapshot | 2026-09-25T06-45-01Z | 2026-09-25T06-45-01Z | yes |
...
| season odds on the page = reports/season_odds.csv (teams; Super Bowl, division and playoff odds) | [32, [0.1316, 0.1163, 0.108, 0.0938, 0.0713, 0.067, 0.0632, 0.0589, 0.0548, 0.05 | [32, [0.1316, 0.1163, 0.108, 0.0938, 0.0713, 0.067, 0.0632, 0.0589, 0.0548, 0.05 | yes |

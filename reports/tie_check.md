# Tie-out (sources and page), 2026-09-24 01:27 UTC

The same number must read the same everywhere it appears. Each row: what was compared, what it says, what it should say.

| Check | Reads | Should read | Ties |
|---|---|---|---|
| README flag record, held out | 46-30 | 46-30 | yes |
| README flag record, 2019 to 2025 | 135-94 | 135-94 | yes |
| README flag record, outside Week 18 | 128-84 | 128-84 | yes |
| README held-out margin miss | 9.93 | 9.93 | yes |
| threshold sweep, cut 4, 2019-22 | 86-60 | 86-60 | yes |
| threshold sweep, cut 4, 2023-25 | 42-24 | 42-24 | yes |
| docs section 9 row, cut 4, 2019-22 | 86-60 | 86-60 | yes |
| docs section 9 row, cut 4, 2023-25 | 42-24 | 42-24 | yes |
...
| docs section 9 rule table: 4+ edge (the flag) | 62-57 | 86-60 | 42-24 | 62-57 | 86-60 | 42-24 | yes |
| track record backtest columns: 4+ edge (the flag) | 62-57 | 86-60 | 42-24 | 62-57 | 86-60 | 42-24 | yes |
| docs section 9 rule table: 4.5+ edge | 41-44 | 62-37 | 25-15 | 41-44 | 62-37 | 25-15 | yes |
| track record backtest columns: 4.5+ edge | 41-44 | 62-37 | 25-15 | 41-44 | 62-37 | 25-15 | yes |
| docs section 9 rule table: 4+ edge, model's side the underdog or pick'em | 45-35 | 76-46 | 32-19 | 45-35 | 76-46 | 32-19 | yes |
| track record backtest columns: 4+ edge, model's side the underdog or pick'em | 45-35 | 76-46 | 32-19 | 45-35 | 76-46 | 32-19 | yes |
| docs section 9 rule table: 4+ edge, weeks 1 to 13 only | 47-42 | 71-44 | 31-19 | 47-42 | 71-44 | 31-19 | yes |
| track record backtest columns: 4+ edge, weeks 1 to 13 only | 47-42 | 71-44 | 31-19 | 47-42 | 71-44 | 31-19 | yes |
| docs by-week row: weeks 1 | 175 +0.01 53 14-10 58 | 175 +0.01 53 14-10 58 | yes |
| docs by-week row: weeks 2 | 176 -0.06 53 17-7 71 | 176 -0.06 53 17-7 71 | yes |
| docs by-week row: weeks 3 | 176 +0.09 52 15-11 58 | 176 +0.09 52 15-11 58 | yes |
| docs by-week row: weeks 4 | 171 +0.23 49 11-6 65 | 171 +0.23 49 11-6 65 | yes |
| docs by-week row: weeks 5 to 8 | 632 +0.17 50 44-35 56 | 632 +0.17 50 44-35 56 | yes |
| docs by-week row: weeks 9 to 13 | 793 +0.15 50 48-36 57 | 793 +0.15 50 48-36 57 | yes |
| docs by-week row: weeks 14 to 17 | 692 +0.20 51 41-36 53 | 692 +0.20 51 41-36 53 | yes |
| docs by-week row: weeks 18 | 80 +0.46 57 7-10 41 | 80 +0.46 57 7-10 41 | yes |
| docs by-week row: weeks Playoffs | 133 +0.24 52 10-8 56 | 133 +0.24 52 10-8 56 | yes |
...
| props backtest errors on the page = props_by_season.csv (the adopted rule, walk-forward, league averages as of each game) | {'rec_yards': [19.31, 18.28], 'rush_yards': [17.86, 17.04], 'pass_yards': [56.6, | {'rec_yards': [19.31, 18.28], 'rush_yards': [17.86, 17.04], 'pass_yards': [56.6, | yes |
...
| props by-season run = the official-numbers refit's rows for the adopted rule (yards, both windows; within 0.006) | {'rec_yards': [19.31, 18.28], 'rush_yards': [17.86, 17.04], 'pass_yards': [56.6, | {'rec_yards': [19.31, 18.28], 'rush_yards': [17.86, 17.04], 'pass_yards': [56.6, | yes |
...
| props count backtests on the page = props_by_season.csv (the adopted rule, walk-forward, league averages as of each game) | {'rec_catches': [1.43, 1.35], 'rec_td_ll': [0.5094, 0.4857], 'rush_td_ll': [0.57 | {'rec_catches': [1.43, 1.35], 'rec_td_ll': [0.5094, 0.4857], 'rush_td_ll': [0.57 | yes |
...
| props record on the page = every projection file, graded rows and market rows | [8300, 5441, 0] | [8300, 5441, 0] | yes |
...
| cards' newest line snapshot = the line log's newest snapshot | 2026-09-24T00-30-19Z | 2026-09-24T00-30-19Z | yes |
| cards' Vegas win chance uses the line log's newest moneyline snapshot | 2026-09-22T18-01-06Z | 2026-09-22T18-01-06Z | yes |
...
| season odds on the page = reports/season_odds.csv (teams; Super Bowl, division and playoff odds) | [32, [0.1277, 0.1166, 0.1141, 0.0959, 0.0725, 0.0697, 0.0582, 0.0566, 0.0523, 0. | [32, [0.1277, 0.1166, 0.1141, 0.0959, 0.0725, 0.0697, 0.0582, 0.0566, 0.0523, 0. | yes |
...
| season backtest on the page = reports/season_backtest.csv (base variant, window means: wins off, division Brier, Super Bowl log loss) | [['2019-22', 1.356, 0.0847, 2.4631], ['2023-25', 1.581, 0.1377, 2.9172]] | [['2019-22', 1.356, 0.0847, 2.4631], ['2023-25', 1.581, 0.1377, 2.9172]] | yes |
...
| sizing backtest flag records = the rule records on the Bets tab (2019-22, 2023-25) | ['86-60', '42-24'] | ['86-60', '42-24'] | yes |

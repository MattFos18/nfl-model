# Tie-out (sources and page), 2026-09-25 20:30 UTC
...
| README flag record, 2019 to 2025 | 127-79 | 127-79 | yes |
| README flag record, outside Week 18 | 120-71 | 120-71 | yes |
| README held-out margin miss | 9.90 | 9.90 | yes |
| threshold sweep, cut 4, 2019-22 | 80-50 | 80-50 | yes |
| threshold sweep, cut 4, 2023-25 | 40-21 | 40-21 | yes |
| docs section 9 row, cut 4, 2019-22 | 80-50 | 80-50 | yes |
...
| docs section 9 rule table: 4+ edge (the flag) | 69-55 | 80-50 | 40-21 | 69-55 | 80-50 | 40-21 | yes |
| track record backtest columns: 4+ edge (the flag) | 69-55 | 80-50 | 40-21 | 69-55 | 80-50 | 40-21 | yes |
...
| docs section 9 rule table: 4+ edge, model's side the underdog or pick'em | 51-38 | 73-41 | 32-18 | 51-38 | 73-41 | 32-18 | yes |
| track record backtest columns: 4+ edge, model's side the underdog or pick'em | 51-38 | 73-41 | 32-18 | 51-38 | 73-41 | 32-18 | yes |
| docs section 9 rule table: 4+ edge, weeks 1 to 13 only | 54-41 | 68-36 | 33-16 | 54-41 | 68-36 | 33-16 | yes |
| track record backtest columns: 4+ edge, weeks 1 to 13 only | 54-41 | 68-36 | 33-16 | 54-41 | 68-36 | 33-16 | yes |
| docs section 9 rule table: boosted trees alone, 5+ edge | 95-69 | 83-60 | 35-17 | 95-69 | 83-60 | 35-17 | yes |
| track record backtest columns: boosted trees alone, 5+ edge | 95-69 | 83-60 | 35-17 | 95-69 | 83-60 | 35-17 | yes |
...
| docs by-week row: weeks 9 to 13 | 793 +0.16 49 51-32 61 | 793 +0.16 49 51-32 61 | yes |
...
| docs by-week row: weeks Playoffs | 133 +0.29 47 7-5 58 | 133 +0.29 47 7-5 58 | yes |
...
| picks file stakes = tracker stakes | [0.86] | [0.86] | yes |
| picks markdown names the live cut | True | True | yes |
| picks markdown header records (tuning, held out, untouched) | 80-50 40-21 69-55 | 80-50 40-21 69-55 | yes |
...
| This week's pull times = the newest rows in the line and prop logs | {'espn': '2026-09-25T20:18Z', 'oddsapi': '2026-09-25T12:03Z', 'props': '2026-09- | {'espn': '2026-09-25T20:18Z', 'oddsapi': '2026-09-25T12:03Z', 'props': '2026-09- | yes |
...
| props record on the page = every projection file, graded rows and market rows | [8337, 5441, 0] | [8337, 5441, 0] | yes |
...
| cards' newest line snapshot = the line log's newest snapshot | 2026-09-25T20-18-21Z | 2026-09-25T20-18-21Z | yes |
| cards' Vegas win chance uses the line log's newest moneyline snapshot | 2026-09-25T20-18-21Z | 2026-09-25T20-18-21Z | yes |
...
| season odds on the page = reports/season_odds.csv (teams; Super Bowl, division and playoff odds) | [32, [0.1316, 0.1162, 0.1084, 0.0934, 0.071, 0.0673, 0.0635, 0.0591, 0.0544, 0.0 | [32, [0.1316, 0.1162, 0.1084, 0.0934, 0.071, 0.0673, 0.0635, 0.0591, 0.0544, 0.0 | yes |
...
| sizing backtest flag records = the rule records on the Bets tab (2019-22, 2023-25) | ['80-50', '40-21'] | ['80-50', '40-21'] | yes |

# Tie-out (sources and page), 2026-09-24 14:26 UTC

The same number must read the same everywhere it appears. Each row: what was compared, what it says, what it should say.

| Check | Reads | Should read | Ties |
|---|---|---|---|
| README flag record, held out | 45-27 | 45-27 | yes |
| README flag record, 2019 to 2025 | 130-88 | 130-88 | yes |
| README flag record, outside Week 18 | 123-78 | 123-78 | yes |
| README held-out margin miss | 9.91 | 9.91 | yes |
| threshold sweep, cut 4, 2019-22 | 82-57 | 82-57 | yes |
| threshold sweep, cut 4, 2023-25 | 41-21 | 41-21 | yes |
| docs section 9 row, cut 4, 2019-22 | 82-57 | 82-57 | yes |
| docs section 9 row, cut 4, 2023-25 | 41-21 | 41-21 | yes |
...
| docs section 9 rule table: 4+ edge (the flag) | 62-61 | 82-57 | 41-21 | 62-61 | 82-57 | 41-21 | yes |
| track record backtest columns: 4+ edge (the flag) | 62-61 | 82-57 | 41-21 | 62-61 | 82-57 | 41-21 | yes |
| docs section 9 rule table: 4.5+ edge | 41-42 | 54-35 | 27-14 | 41-42 | 54-35 | 27-14 | yes |
| track record backtest columns: 4.5+ edge | 41-42 | 54-35 | 27-14 | 41-42 | 54-35 | 27-14 | yes |
| docs section 9 rule table: 4+ edge, model's side the underdog or pick'em | 46-37 | 74-44 | 33-16 | 46-37 | 74-44 | 33-16 | yes |
| track record backtest columns: 4+ edge, model's side the underdog or pick'em | 46-37 | 74-44 | 33-16 | 46-37 | 74-44 | 33-16 | yes |
| docs section 9 rule table: 4+ edge, weeks 1 to 13 only | 47-45 | 68-41 | 34-17 | 47-45 | 68-41 | 34-17 | yes |
| track record backtest columns: 4+ edge, weeks 1 to 13 only | 47-45 | 68-41 | 34-17 | 47-45 | 68-41 | 34-17 | yes |
| docs by-week row: weeks 1 | 175 +0.02 51 16-11 59 | 175 +0.02 51 16-11 59 | yes |
| docs by-week row: weeks 2 | 176 -0.07 55 18-7 72 | 176 -0.07 55 18-7 72 | yes |
| docs by-week row: weeks 3 | 176 +0.10 51 15-9 62 | 176 +0.10 51 15-9 62 | yes |
| docs by-week row: weeks 4 | 171 +0.23 47 12-5 71 | 171 +0.23 47 12-5 71 | yes |
| docs by-week row: weeks 5 to 8 | 632 +0.17 50 43-35 55 | 632 +0.17 50 43-35 55 | yes |
| docs by-week row: weeks 9 to 13 | 793 +0.15 49 45-36 56 | 793 +0.15 49 45-36 56 | yes |
| docs by-week row: weeks 14 to 17 | 692 +0.20 52 36-36 50 | 692 +0.20 52 36-36 50 | yes |
| docs by-week row: weeks 18 | 80 +0.46 56 7-10 41 | 80 +0.46 56 7-10 41 | yes |
| docs by-week row: weeks Playoffs | 133 +0.27 50 9-7 56 | 133 +0.27 50 9-7 56 | yes |
...
| picks file stakes = tracker stakes | [1.33] | [1.33] | yes |
| picks markdown names the live cut | True | True | yes |
| picks markdown header records (tuning, held out, untouched) | 82-57 41-21 62-61 | 82-57 41-21 62-61 | yes |
...
| published page size under 60 MB (the cap is 64 MB a version) | 56.6 MB | under 60 MB | yes |
...
| This week's pull times = the newest rows in the line and prop logs | {'espn': '2026-09-24T14:18Z', 'oddsapi': '2026-09-24T12:08Z', 'props': '2026-09- | {'espn': '2026-09-24T14:18Z', 'oddsapi': '2026-09-24T12:08Z', 'props': '2026-09- | yes |
...
| props record on the page = every projection file, graded rows and market rows | [8315, 5441, 0] | [8315, 5441, 0] | yes |
...
| cards' newest line snapshot = the line log's newest snapshot | 2026-09-24T14-18-28Z | 2026-09-24T14-18-28Z | yes |
| cards' Vegas win chance uses the line log's newest moneyline snapshot | 2026-09-24T14-18-28Z | 2026-09-24T14-18-28Z | yes |
...
| season odds on the page = reports/season_odds.csv (teams; Super Bowl, division and playoff odds) | [32, [0.1296, 0.1136, 0.1077, 0.0978, 0.0704, 0.0684, 0.0595, 0.0595, 0.0551, 0. | [32, [0.1296, 0.1136, 0.1077, 0.0978, 0.0704, 0.0684, 0.0595, 0.0595, 0.0551, 0. | yes |
...
| season backtest on the page = reports/season_backtest.csv (base variant, window means: wins off, division Brier, Super Bowl log loss) | [['2019-22', 1.3565, 0.0842, 2.4761], ['2023-25', 1.579, 0.1378, 2.8598]] | [['2019-22', 1.3565, 0.0842, 2.4761], ['2023-25', 1.579, 0.1378, 2.8598]] | yes |
...
| Bets tab: cover_cal on the page = reports/cover_calibration.csv (rows) | 12 | 12 | yes |
| Bets tab: cal_start on the page = reports/calibration_start.csv (rows) | 7 | 7 | yes |
| sizing backtest flag records = the rule records on the Bets tab (2019-22, 2023-25) | ['82-57', '41-21'] | ['82-57', '41-21'] | yes |

...
- Encompassing, 2023-25: margin = 0.16 + 0.932 x line + 0.253 x model (model t = 1.21). A model weight above zero with t past 2 means the line does not already contain what the model knows.

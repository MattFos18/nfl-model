...
- Encompassing, 2019-22: margin = -0.88 + 0.722 x line + 0.325 x model (model t = 1.92). A model weight above zero with t past 2 means the line does not already contain what the model knows.
- Encompassing, 2023-25: margin = 0.16 + 0.934 x line + 0.251 x model (model t = 1.20). A model weight above zero with t past 2 means the line does not already contain what the model knows.
- Encompassing, all: margin = -0.43 + 0.787 x line + 0.311 x model (model t = 2.37). A model weight above zero with t past 2 means the line does not already contain what the model knows.

...
- Encompassing, all: margin = -0.43 + 0.786 x line + 0.312 x model (model t = 2.38). A model weight above zero with t past 2 means the line does not already contain what the model knows.

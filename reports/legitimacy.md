...
- Encompassing, 2019-22: margin = -0.88 + 0.722 x line + 0.324 x model (model t = 1.92). A model weight above zero with t past 2 means the line does not already contain what the model knows.

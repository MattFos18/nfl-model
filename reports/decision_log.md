...
|---|---|---|---|---|
| 21 Sep 2026 | The 3 point spread rule (Matt: an idea, not solidified). Find the ROI-best threshold | Sweep 0 to 7 points on 2019 to 2025 and on each window (`docs/how_it_works.md` section 8), bootstrap 2,000 resamples | Under 4.5 loses in every window. Spreads 5+: 131 bets, 54.2%, +3.5% ROI, positive in both windows, P(ROI>0) 69%. 6+: 65 bets, 60.0%, +14.5%, both windows, 87%. Totals 6+: 57 bets, 61.4%, +17.2%, 93% | Display rule moved to 5 (spreads) and 6 (totals) with the sample size shown. None clears the 95% bar yet; a lead to track live, not a proven edge |
